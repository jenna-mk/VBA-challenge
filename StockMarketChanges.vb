    ...
    For Each ws In Worksheets
        ...
        For row_ = 2 To last_row
            ...
            If ws.Cells(row_ + 1, 1).Value <> ws.Cells(row_, 1).Value Then
                ...
                '------------------------------------------
                ' Note: inspiration for the following code to find yearly change and percent change 
                '   was taken from "VBA-Challenge" (DataTell, 2020), found on GitHub.
                '   Source Code: https://github.com/DataTell/VBA-Challenge/tree/master/VBAStocks
        ...
        ' Note: portions of and inspiration for the following code to find the greatest
        '   increase, decrease, and total stock volume were taken from "VBA-Challenge" (DataTell, 2020), found on GitHub. 
        '   Source code: https://github.com/DataTell/VBA-Challenge/tree/master/VBAStocks
        ' ------------------------------------------------
